...
from APIgen.utility import mkdir, getDirContent
from APIgen.containers import Everything, State
from APIgen.regexes import regexes
from APIgen.parser import Parser
...
class Extractor(object):
    ...
    def generate(self):
        ...
        if isinstance(self.inputdirs, str):
